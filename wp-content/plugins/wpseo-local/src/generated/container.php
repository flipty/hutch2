...
class Cached_Container extends Container
{
    ...
    {
        return $this->services['Yoast\\WP\\Local\\Repositories\\Timezone_Repository'] = new \Yoast\WP\Local\Repositories\Timezone_Repository(${($_ = isset($this->services['Yoast\\WP\\Local\\Repositories\\Api_Keys_Repository']) ? $this->services['Yoast\\WP\\Local\\Repositories\\Api_Keys_Repository'] : ($this->services['Yoast\\WP\\Local\\Repositories\\Api_Keys_Repository'] = new \Yoast\WP\Local\Repositories\Api_Keys_Repository())) && false ?: '_'});
    }
