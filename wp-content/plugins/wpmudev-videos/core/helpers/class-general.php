...
class General {
	 ...
	 * @param bool   $return Should return the content as string.
	 *
	 * @since 1.7
	 *
	 * @return void|string
	 */
	public static function view( $view, $args = array(), $return = false ) {
		// Default views.
	...
	public static function is_valid_member() {
		...
		if ( class_exists( 'WPMUDEV_Dashboard' ) ) {
			...
			// If purchased the plugin alone.
			if ( ( 'unit' === $status && in_array( 248, $projects, true ) ) || ( 'single' === $status && 248 === $projects ) ) {
				return true;
			}
		}

		// Membership status should be full or project access should be there.
		return 'full' === $status;
	}
