...
class Locale {
	...
	public static function welcome() {
		return array(
			'title' => array(
				'new_welcome_title' => __( 'New: Analytics 4 property!', 'ga_trans' ),
			),
			'desc'  => array(
				'new_welcome_desc'  => __( 'Beehive\'s new integrated Google Analytics 4 feature will allow you to start gathering data and benefit from the latest innovations as they become available, while keeping your current implementation intact. The new Google Analytics 4 is now the default experience for all new properties, so let’s get ready for the next generation of Analytics innovation!', 'ga_trans' ),
				'new_welcome_desc2' => sprintf(
				/* translators: %s: Link to GA4 page. */
					__( 'To learn more about it, check out <a href="%s" target="_blank">What\'s new</a>.', 'ga_trans' ),
