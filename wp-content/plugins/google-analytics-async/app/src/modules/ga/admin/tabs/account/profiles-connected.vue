<template>
	<div class="google-account-selector">
		<sui-notice type="default" v-if="accountSelected">
			<p v-html="$i18n.notice.ga4_not_available_selected"></p>
		</sui-notice>
		<sui-notice type="default" v-else>
			<p v-html="$i18n.notice.ga4_not_available"></p>
		</sui-notice>
		<profiles
