...
function mpfy_pc_map_custom_fields($custom_fields) {
	...
	$custom_fields = mpfy_array_push_key($custom_fields, 'position_after_ui', array(
		...
		'map_tooltip_background_transparency'=>Carbon_Field::factory('text', 'map_tooltip_background_transparency', 'Tooltip Transparency')
			->set_default_value('71')
			->help_text('Use a valud in the 0-100 percent range; do not include a percent sign.'),
