...
$map_custom_fields = array(
	...
	'map_search_radius_unit'=>Carbon_Field::factory('select', 'map_search_radius_unit', 'Search Radius Unit')
		->add_options(array( 'mi' => 'Miles', 'km' => 'Kilometers' )),
	'map_search_radius'=>Carbon_Field::factory('text', 'map_search_radius', 'Search Radius')
		->set_default_value(5),
	'map_search_region_bias'=>Carbon_Field::factory('text', 'map_search_region_bias', 'Search Region Bias')
		->set_default_value('')
		->help_text('Used to help search choose between similarly named locations in different regions. Optional. For example: UK'),
